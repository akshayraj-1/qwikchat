        ...
        <AnimatePresence mode="wait">
            {
                ...
                <Backdrop onClick={onCancel}>
                    <motion.div variants={variants}
                                ...
                                className={cn("absolute flex flex-wrap justify-center gap-5 px-9 py-9 w-full bg-colorBackground border-t border-colorSurfaceLight", position === "bottom" ? "bottom-0" : "top-0")}>
