        ...
        showLoader
            ...
            : <div className="relative flex justify-center items-center h-full w-full">
                ...
                <motion.div variants={variants} initial="initial" animate="final"
                            className="relative flex flex-col items-center justify-center shadow-2xl px-7 py-5 min-w-80 bg-colorSurface border border-colorSurfaceLight rounded-2xl text-sm
                            before:absolute before:-top-14 before:size-32 before:bg-colorSurface before:border-t before:border-r before:-rotate-45 before:border-colorSurfaceLight before:rounded-full">

                    {
                        !avatarLoaded && <div className="absolute z-[2] -top-[2.8rem] size-[6.8rem] p-3 bg-colorSurfaceLight/20 rounded-full animate-pulse" ></div>
                    }
                    ...
                    <input id="roomId"
                           className="w-full px-3 py-2 mt-1.5 text-base sm:text-sm rounded-md border border-colorSurfaceLight bg-colorSurfaceVariant outline-0"
                           type="text"
                           disabled={true}
                           value={roomId}/>
                    ...
                    <input ref={usernameRef}
                           id="username"
                           className="w-full px-3 py-2 mt-1.5 mb-3 text-base sm:text-sm rounded-md border border-colorSurfaceLight bg-colorSurfaceVariant outline-0"
